...
class TestPlot(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        self.assertEqual('foo', d['image'])
        self.assertEqual('foo is the caption', d['caption'])
        self.assertEqual(Plot.PLOT_TYPE, d['plotType'])
    ...
    def test_plotly_plot(self):
        ...
        self.assertEqual('foo', d['image'])
        self.assertEqual('foo is the caption', d['caption'])
        self.assertEqual(d['plotType'], PlotlyPlot.PLOT_TYPE)
        self.assertEqual(d['plotlyVersion'], "1.2.3")
